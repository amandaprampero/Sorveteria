...
public class DisplaySorveteria {
     ...
     * @throws Exception
     */
    public void cadastroGui(ActionEvent e, String nome, String email, String telefone, String senha, String rua, String bairro,String num) throws UsuarioJaExisteException{
     ...
     * @throws Exception
     */
    public void cadastroGui(ActionEvent e, String nome, String email, String telefone, String senha) throws UsuarioJaExisteException{
    ...
    public void loggedGui(ActionEvent e){
        if(sorveteria.getClienteLogado()!=null){
            ...
            try{
                ...
                loggedinController.setCliente(sorveteria.getClienteLogado());
