...
public class SorveteriaSistema {
     ...
     * @throws Exception
     */
    public void adicionarNovoCliente(Cliente novo) throws UsuarioJaExisteException{
        ...
        try{
            ...
            System.err.println("Erro com arquivo Cliente");
        }
     ...
     * @throws Exception
     */
    public void adicionarNovoEntregador(Entregador novo) throws UsuarioJaExisteException{
        ...
        try{
            ...
            System.err.println("Erro com arquivo Entregadores");
        }
